...
const TCHAR* APlayerWheeledVehicle::VehicleSkeletalMeshPath = TEXT("SkeletalMesh'/Game/CrazyDrift/Vehicles/SimpleCar/Models/SimpleCar.SimpleCar'");
const TCHAR* APlayerWheeledVehicle::VehicleAnimClassPath = TEXT("AnimBlueprint'/Game/CrazyDrift/Vehicles/SimpleCar/Animations/SimpleCar_AnimBlueprint.SimpleCar_AnimBlueprint_C'");
const TCHAR* APlayerWheeledVehicle::VehicleWheelFrontClassPath = TEXT("Blueprint'/Game/CrazyDrift/Vehicles/SimpleCar/Blueprints/BP_VehicleWheel_Front.BP_VehicleWheel_Front_C'");
const TCHAR* APlayerWheeledVehicle::VehicleWheelBackClassPath = TEXT("Blueprint'/Game/CrazyDrift/Vehicles/SimpleCar/Blueprints/BP_VehicleWheel_Back.BP_VehicleWheel_Back_C'");
